...
android {
    namespace = "org.michaelbel.mergetag"
    compileSdk = libs.versions.compile.sdk.get().toInt()

    defaultConfig {
        applicationId = "org.michaelbel.mergetag"
...
base {
    archivesName.set("MergeTag-v${android.defaultConfig.versionName}(${android.defaultConfig.versionCode})")
}
